...
const ProfileDetails: React.FC = () => {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      setLoader(false);
      dispatch({ type: "LOG_IN", payload: auth.currentUser });
      successToast("profile succsesfuly updated", "");
    } catch (error) {
      errorToast(
        "cant update the profile",
        "try again and make sure about your network"
      );
      setLoader(false);
    }
  };
  ...
  return (
    <div className="profile-details">
      ...
      <div className="profile-details__personal-info">
        <h4 className="profile-details__personal-info__title">
