    ...
    if (isAuth) {
      if (cart.length > 0) {
        try {
          ...
          setLoader(false);
          errorToast(
            "cant place your order",
            "make sure that put evrything right"
          );
        }
      }
    } else {
      ...
      <div className="checkout">
        <div className="checkout__left">
          ...
          <p className="checkout__left__discription">
            please fill the form below to order it,however you are not realy buy
            it{" "}
          </p>
            ...
            <div className="checkout__right__box__products">
              {cart.map((product, i) => (
                <div key={i} className="checkout__right__product">
                  ...
                  <h5 className="checkout__right__product__quantity">
                    {product.quantity}
                  </h5>
                </div>
              ))}
